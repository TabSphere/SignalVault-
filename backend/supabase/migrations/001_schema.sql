...
drop policy if exists "Users can view own delivered signals" on public.user_signals;
...
drop policy if exists "Authenticated users can view prices" on public.price_snapshots;
